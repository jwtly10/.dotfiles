...
" let s:col.string     = ['#37ad82', 72] " Dark green
let s:col.string = ['#d1d1d1', 188]    " Foreground - white
...
call s:HL('SpellBad',   'error',   'none',       'none,underline')
...
if has('nvim')
  ...
  call s:HL('NormalFloat', 'foreground', 'light_bg')
  call s:HL('FloatBorder', 'comment',    'light_bg')
  call s:HL('FloatTitle',  'lemon',      'light_bg')

  " Pmenu
  call s:HL('Pmenu',      'foreground', 'light_bg')
  call s:HL('PmenuSel',   'background', 'lemon')
  call s:HL('PmenuSbar',  'light_bg',   'light_bg')
  call s:HL('PmenuThumb', 'function',   'lighter_bg')

  " Treesitter - Tags
  call s:HL('@tag',                  'type',       'none')
  call s:HL('@tag.delimiter',        'type',       'none')
  call s:HL('@tag.attribute',        'lemon',      'none')
  call s:HL('@constructor.jsx',      'type',       'none')
  call s:HL('@constructor.tsx',      'type',       'none')
  call s:HL('@tag.jsx',              'type',       'none')
  call s:HL('@tag.tsx',              'type',       'none')
  call s:HL('@tag.delimiter.jsx',    'type',       'none')
  call s:HL('@tag.delimiter.tsx',    'type',       'none')
  call s:HL('@tag.attribute.jsx',    'lemon',      'none')
  call s:HL('@tag.attribute.tsx',    'lemon',      'none')

  " Treesitter - General
  call s:HL('@text.literal',         'string',     'none')
  call s:HL('@text.reference',       'type',       'none')
  call s:HL('@text.title',           'lemon',      'none')
  call s:HL('@text.uri',             'preproc',    'none')
  call s:HL('@text.strong',          'foreground', 'none')
  call s:HL('@text.emphasis',        'foreground', 'none')
  call s:HL('@property',             'lemon',      'none')
  call s:HL('@variable',             'foreground', 'none')
  call s:HL('@variable.builtin',     'special',    'none')
  call s:HL('@constructor',          'type',       'none')
  call s:HL('@constant',             'constant',   'none')
  call s:HL('@string.escape',        'preproc',    'none')
  call s:HL('@parameter',            'foreground', 'none')
  call s:HL('@punctuation.bracket',  'foreground', 'none')
  call s:HL('@punctuation.delimiter','foreground', 'none')
endif
" }}}
