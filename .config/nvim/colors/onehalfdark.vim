...
" }
  ...
  " LSP Hover and Floating Window Colors {
if has('nvim')
  call s:h("NormalFloat", s:fg, s:cursor_line, "") " LSP floating window color
  call s:h("FloatBorder", s:comment_fg, s:cursor_line, "") " Border color for floating windows
endif
" }
...
if has('nvim')
    ...
    call s:h("@tag", s:blue, "", "")
    call s:h("@tag.delimiter", s:blue, "", "")
    call s:h("@tag.attribute", s:yellow, "", "")
    call s:h("@constructor.jsx", s:blue, "", "")
    call s:h("@constructor.tsx", s:blue, "", "")

    " JSX/TSX specific
    call s:h("@tag.jsx", s:blue, "", "")
    call s:h("@tag.tsx", s:blue, "", "")
    call s:h("@tag.delimiter.jsx", s:blue, "", "")
    call s:h("@tag.delimiter.tsx", s:blue, "", "")
    call s:h("@tag.attribute.jsx", s:yellow, "", "")
    call s:h("@tag.attribute.tsx", s:yellow, "", "")

    " General Treesitter groups
    call s:h("@text.literal", s:green, "", "")
    call s:h("@text.reference", s:blue, "", "")
    call s:h("@text.title", s:blue, "", "bold")
    call s:h("@text.uri", s:cyan, "", "")
    call s:h("@text.strong", s:fg, "", "bold")
    call s:h("@text.emphasis", s:fg, "", "italic")
    call s:h("@property", s:yellow, "", "")
    call s:h("@variable", s:white, "", "")
    call s:h("@variable.builtin", s:red, "", "")
    call s:h("@constructor", s:blue, "", "")
    call s:h("@constant", s:yellow, "", "")
    call s:h("@string.escape", s:cyan, "", "")
    call s:h("@parameter", s:white, "", "")
